...
window.POCHA_I18N = {
  es: {
    ...
    tricksCheck: function (sum, cards) { return 'Revisa las bazas anotadas: suman ' + sum + ' y la mano tiene ' + cards + ' ' + (cards === 1 ? 'carta' : 'cartas') + '. La ronda no se guarda hasta que cuadren.'; },
  ...
  en: {
    ...
    tricksCheck: function (sum, cards) { return 'Check the tricks entered: they add up to ' + sum + ' and the hand has ' + cards + ' ' + (cards === 1 ? 'card' : 'cards') + '. The round is not saved until they match.'; },
